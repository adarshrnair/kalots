...
<table>
 ...
 <tr>
	<td>
                  <a href="regprograms.php"><input type="button"  id="b4" value="Registered Programs" > 
                  </a> 
 ...
 <tr>
	<td>
                  <a href="plist.php"><input type="button"  id="b4" value="Program List" > 
                  </a>
 ...
 <tr>
	<td>
                  <a href="changepass.php"><input type="button"  id="b4" value="Change Password" > 
                  </a>
